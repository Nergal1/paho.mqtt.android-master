        ...
        adapter.addOnUnsubscribeListner(new SubscriptionListItemAdapter.OnUnsubscribeListner() {
            ...
            public void onUnsubscribe(Subscription subscription) {
                try {
                    ...
                    Log.i("MQTT_"+this.getClass().getName(),"Unsubscribed from: " + subscription.toString());
                } catch (MqttException ex) {
                    Log.i("MQTT_"+this.getClass().getName(),"Failed to unsubscribe from " + subscription.toString() + ". " + ex.getMessage());
                }
            }
        });
        ...
        alertDialogBuilder.setCancelable(true).setPositiveButton(R.string.subscribe_ok, new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int id) {
                ...
                try {
                    ...
                    Log.i("MQTT_"+this.getClass().getName(),"MqttException whilst subscribing: " + ex.getMessage());
                }
