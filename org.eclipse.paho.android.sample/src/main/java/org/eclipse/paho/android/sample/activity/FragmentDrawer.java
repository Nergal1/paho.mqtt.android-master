...
public class FragmentDrawer extends Fragment {
    ...
    public void addConnection(Connection connection){
        Log.i("MQTT_"+this.getClass().getName(),"Adding new Connection:  " + connection.getId());
    ...
    public void updateConnection(Connection connection) {
        Log.i("MQTT_"+this.getClass().getName(),"Updating Connection: " + connection.getId());
    ...
    public void removeConnection(Connection connection){
        Log.i("MQTT_"+this.getClass().getName(),"Removing connection from drawer: " + connection.getId());
        Iterator<NavDrawerItem> iterator = data.iterator();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView.addOnItemTouchListener(new RecyclerTouchListener(getActivity(), recyclerView, new ClickListener() {
            ...
            public void onLongClick(int position) {
                Log.i("MQTT_"+this.getClass().getName(),"I want to delete: " + position);
