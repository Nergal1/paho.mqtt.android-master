...
public class HistoryFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Log.i("MQTT_"+this.getClass().getName(),"History Fragment: " + connection.getId());
        setHasOptionsMenu(true);
        ...
        connection.addReceivedMessageListner(new IReceivedMessageListener() {
            ...
            public void onMessageReceived(ReceivedMessage message) {
                Log.i("MQTT_"+this.getClass().getName(),"GOT A MESSAGE in history " + new String(message.getMessage().getPayload()));
                Log.i("MQTT_"+this.getClass().getName(),"M: " + messages.size());
