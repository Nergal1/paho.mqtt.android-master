 ...
 * the action
 * 客户端动作：CONNECT，DISCONNECT，SUBSCRIBE，UNSUBSCRIBE，PUBLISH
 * 的监听类：onSuccess onFailed
 */
public class ActionListener implements IMqttActionListener {

    private static final String TAG = "MQTT_ActionListener";
    ...
    private void publish() {
        ...
        Log.i("MQTT_"+this.getClass().getName(),"Published");
    ...
    private void subscribe() {
        ...
        c.addAction(actionTaken);
        Notify.toast(context, actionTaken, Toast.LENGTH_SHORT);
        Log.i("MQTT_"+this.getClass().getName(),actionTaken);
    ...
    private void publish(Throwable exception) {
        ...
        if (exception!=null)
        Log.e(TAG,"Client failed to publish. Exception信息:"+exception.toString());
    ...
    private void subscribe(Throwable exception) {
        ...
        Notify.toast(context, action, Toast.LENGTH_SHORT);
        if (exception!=null)
        Log.e(TAG,"Client failed to subscribe. Exception信息:"+exception.toString());
    ...
    private void unSubscribe(Throwable exception) {
        ...
        Notify.toast(context, action, Toast.LENGTH_SHORT);
        if (exception!=null)
        Log.e(TAG,"Client failed to unSubscribe. Exception信息:"+exception.toString());
    ...
    private void disconnect(Throwable exception) {
        ...
        if (exception!=null)
        Log.e(TAG,"Client failed to disconnect. Exception信息:"+exception.toString());
    }
    ...
    private void connect(Throwable exception) {
        ...
        if (exception!=null)
        Log.e(TAG,"Client failed to connect. Exception信息:"+exception.toString());
    }
